...
- [x] Start thinking about what we want to do for project 2

Progress for this week: 

- Presented our project proposal and began work on collecting our data
...
- [x] Create a file to store datasets
- [x] Refine research questions to focus more on competitors
- [x] Continue to find datasets that are relevant to our research questions
- [ ] Import all datasets into R and clean them
- [ ] Potentially start working on cleaning any datasets that have a lot of missing values, typos, remove and or add whitespace characters, etc.

Progress for this week:

- Refined our research questions and data to focus more on Chipotle's competitors and customers
- Created a file to store datasets
- Manually combined datasets together in excel by year and started to import the datasets into R

4/7/26:

Goals for this week:

- [x] Continue to import all the datasets into R
- [x] Begin to clean the data and find ways to merge more complex datasets together 
- [ ] Possibly start performing an exploratory data analysis and create visuals for the data

Progress for this week: 

- Successfully loaded the csv files and scrapped the other files from the web
- Cleaned the main datasets that we will use (chipotle financial data, store locations data, and U.S. population data)
- Filled in missing values by fitting a line to each column and predicting the past values 

4/12/26:

Goals for this week: 

- [x] Perform an exploratory data analysis and create visuals 
- [x] Research why there are drops in some of the financial data to try to explain it better
- [x] Start performing regression models, random forests, etc. 

Progress for this week: 

- Generated various graphs to visualize the data including bar graphs, scatter plots, and heat maps
- Calculated values and new tables to make analyzes easier to model 
- Began working on a Covid-19 analysis and Chipotle population to store locations comparison  

4/19/26: 

Goals for this week: 

- [x] Continue performing analyses on the data and answering our research questions 
- [ ] Merge each of our codes together into one file
- [ ] Potentially start working on generating the report 

Progress for this week: 

- Merged population, total number of stores, and consumption data for each state 
- Visually represented data though graphics, mostly maps of the US
- Ran regression models for Covid year performance for Chipotle and competitors 
- Ran regression models and performed diagnostics for US state data mentioned above 

4/24/26: 

Goals for this week: 

- [ ] Finish any final analyses and make sure to incorporate basic plots as well 
- [ ] Start writing paper and preparing most important results for presentation  
