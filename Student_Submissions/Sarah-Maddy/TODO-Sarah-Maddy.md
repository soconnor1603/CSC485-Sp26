...
- Mannually combined datasets together in excel by year and started to import the datasets into R

4/7/26:

Goals for this week:
- [ ] Continue to import all the datasets into R
- [ ] Begin to clean the data and find ways to merge more complex datasets together 
